...
exports.updateProductSchema = joi_1.default.object({
    ...
    brandId: joi_1.default.number().optional(), subCategoryId: joi_1.default.number().required(),
    productType: joi_1.default.string().valid(...Object.values(products_entity_1.PRODUCT_TYPE)).required(),
});
