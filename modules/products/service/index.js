...
class ProductService {
    createProduct(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const productToBeCreated = productRepository.create({
                ...
                gst: validatedData.gst, hsnCode: validatedData.hsnCode,
    ...
    getProductById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { role } = req.user;
            const productRepository = config_1.AppDataSource.getRepository(products_entity_1.Product);
            const product = yield productRepository.findOne({ relations: {
                    category: true, brand: true, subCategory: true
                },
                where: {
                    id: id,
                }, select: {
                    ...
                    description: true, name: true, imageUrl: true, price: true, productType: true, createdAt: true, updatedAt: true, deletedAt: true, hsnCode: true, gst: true, partNumber: true
                }
            });
            if (!product) {
                throw (0, customError_1.CustomError)(`Could not find product with id ${id}`, 404);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const product = yield productRepository.findOne({ relations: {
                ...
                where: {
                    ...
                    description: true, name: true, imageUrl: true, price: true, productType: true, createdAt: true, updatedAt: true, deletedAt: true
                }
            });
            if (!product) {
                throw (0, customError_1.CustomError)(`Could not find product with id ${id}`, 404);
    ...
    getProductListForUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [productList, count] = yield productRepository.findAndCount({
                ...
                select: {
                    id: true, name: true, imageUrl: true, productType: true, createdAt: true, updatedAt: true, deletedAt: true
                }
            });
            return {
                productList, count
